...
**🚀 基础服务 — 99 元（一次付费）**
把你的本地知识库接到**扣子或豆包**，直接在电脑上提问。需要电脑开机才能用。
- 把你的书发给我就行（PDF / txt / epub 都行）
- Mac 和 Windows 电脑都能用
- *可选项：附赠帮你装好 Claude Code + DeepSeek V4 Pro*

**⭐ VIP — 199 元/年**
包含基础服务全部内容（电脑开机使用），再加：
- 加我微信，使用中遇到问题随时问
- 帮你定制专题知识库（考研、考公、考证、学术任选）
- 长期维护你的豆包/扣子等智能体
- 加书更新、代找资料、整理文献

> 目前暂不支持手机上使用。如果项目发展顺利，后续会推出手机端服务（预计 399 元/年），届时老用户有优惠。

**适用人群：**
- 🎓 **考研党** — 政治、英语、专业课，把教材丢进去直接问
- 📚 **期末复习** — 课件、教材、笔记全部导入，复习效率翻倍
- 📝 **写论文** — 文献太多读不完？让 AI 帮你找关键段落
- 🏅 **考公考证** — 法考、CPA、教资，题库式知识库随时查
- 🔬 **学术研究** — 历史、哲学、社科，跨书对比、追溯原文
- 📖 **读书爱好者** — 自己的书库，随时跟 AI 讨论书里的内容
