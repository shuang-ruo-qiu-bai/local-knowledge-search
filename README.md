...
**一套运行在本地的通用知识检索系统。基于语义搜索，追溯到原文。**

把任何领域的书籍、笔记、文献放进来，系统自动建立索引，用自然语言搜索就能找到相关段落。全部在本地运行，不需要联网，不需要上传资料。
...
**这套系统也不局限于文革研究。** 你可以把任何领域的书籍、笔记、文献放进来——古代史、近代史、法律、中医、哲学、小说研究——检索和交叉验证的逻辑是一样的。换一套书就是一个新的知识库。
