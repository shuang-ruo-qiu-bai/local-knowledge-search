...
```
安装 https://github.com/shuang-ruo-qiu-bai/local-knowledge-search 这个 Skill
```
...
这个项目完全开源免费，任何人都可以自行安装使用。但如果你是新手、不想折腾，也可以找我帮你部署。

**🚀 基础部署（68 元，一次付费）**
- 远程帮你装好 Claude Code + DeepSeek
- 建好知识库索引
- 教会你如何使用
...
**适用人群：** 考研党、考证党、做研究、读大量资料需要 AI 辅助的 anyone
